...
* link:articles/Incorporating_user_research_on_live_projects___Part_2[Part 2]: Preparation for the Interview, Competitors Research.

* link:articles/Incorporating_user_research_on_live_projects___Part_3[Part 3]: Context of Pandemic, Transcribing, Affinity Diagraming, Report.

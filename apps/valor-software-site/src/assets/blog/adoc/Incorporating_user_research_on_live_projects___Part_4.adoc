...
* link:blog/Incorporating_user_research_on_live_projects___Part_1[Part 1]: Context of the Project, User Persona, Search for Participants.
* link:blog/Incorporating_user_research_on_live_projects___Part_2[Part 2]: Preparation for the Interview, Competitors Research.

* link:blog/Incorporating_user_research_on_live_projects___Part_3[Part 3]: Context of Pandemic, Transcribing, Affinity Diagraming, Report.

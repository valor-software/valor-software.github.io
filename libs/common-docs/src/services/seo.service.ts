	...
	'privacy-policy': [
		{
			...
			name: 'name',
			nameValue: 'description',
			content: 'This page informs you of our policies regarding collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. '
		},
		{
			nameType: 'meta',
			name: 'property',

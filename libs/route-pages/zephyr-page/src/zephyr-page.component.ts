...
const challenges = [
    {
        challenge: {
            ...
            description: ['Our client cares a lot about users’ personal data safety and the security of their solutions. The zephyr Platform is only available for the organization’s employees, that’s why we paid additional attention to the procedure of authentication and login.']
        },
        solution: {
            title: 'Solution:',
            description: [
                ...
                `We’ve also added the SSO functionality for a better user experience with the app. As our target audience is likely to be limited in time to make their zephyrs and order carriages, SSO simplifies access to the app and eliminates the need to remember usernames and passwords.`,
            ]
        },
        footer: {
            title: 'Impact',
    ...
    },
    {
        challenge: {
            ...
            description: ['Most of our audiences access the Platform from low connectivity locations and high-latency connections. So we intended to create an app that allows users with bad or no connectivity to browse through pages and make zephyrs.']
        },
        solution: {
            title: 'Solution:',
            description: [
        ...
        src: 'assets/img/bg-img/zephyr_page/diagram_2.svg'
    },
    {
        challenge: {
            title: 'Challenge 3',
        ...
        footer: {
            title: 'Impact',
            description: [
                `The zephyr Platform app performs well regardless of users’ phones' processing capacity, as our audience tends to use older versions of smartphones`,
...
const technologiesCards: ITechnologiesCard[] = [
    {
        ...
        technologies: [
            ...
            {
                src: "assets/img/technologies/others/google_cloudflare_cache_worker.png",
                title: "Google Cloudflare Cache Worker"
            }
        ]
    },
...
const deliverablesCards: DeliverablesCards[][] = [
    ...
    },
    {
        ...
        img: 'assets/img/bg-img/zephyr_page/for_staff.png'
    },
    {
        title: 'For drivers',
        isSubtitle: true,
        ...
        img: 'assets/img/bg-img/zephyr_page/for_drivers.png'
    }
    ],
    [
        {
            title: '2. Accommodation zephyr',
            description: [
                "This menu option allows users to create a zephyr in a hotel or a guesthouse in one out of more than a hundred locations across the world. A user picks the place, adds personal information and info connected with the travel, like a purpose, employment details, and flight tickets, and waits till the confirmation of zephyr. Once confirmed, users see all the details of their zephyr in the “My zephyrs” section."
            ],
            img: 'assets/img/bg-img/zephyr_page/accommodation.png'
        }
    ],
    [
        {
            title: '3. zephyr of medical services',
            description: [
            ...
            img: 'assets/img/bg-img/zephyr_page/medical_services.png'
        }
    ],
    [
        {
            title: '4. “My zephyrs” features and capabilities',
            description: [
                `It’s a huge part of functionality where users can view and interact with their zephyrs, whether it’s a hotel, a transfer service zephyr, or a consultation with a doctor. Precisely they can:
               <ul class="list-disc list-inside">
                <li>view the history of zephyrs;</li>
                <li>check the status and cancel zephyr;</li>
                <li>view details: e.g. driver’s contact details;</li>
                <li>contact the driver or the hotel where the zephyr is made;</li>
                <li>rate services and leave feedback;</li>
                <li>create favorites’ lists and rebook destinations;</li>
                <li>save zephyr cards to use offline.</li>
                </ul>
                `
            ],
            img: 'assets/img/bg-img/zephyr_page/features_and_capabilities.png'
        }
    ]
